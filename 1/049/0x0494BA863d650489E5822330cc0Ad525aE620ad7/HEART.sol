...
Telegram: https://t.me/hearterc

Twitter: https://twitter.com/HeartCoinERC
...
contract HEART is ERC20, Ownable {
    ...
    constructor() ERC20("Heart Coin", "HEART") {
        ...
        mktgWallet = address(0x3472B2FEF357cC2C239B32b1791eE1a5C7484096); 
        devWallet = address(0x3472B2FEF357cC2C239B32b1791eE1a5C7484096); 
        liqWallet = address(0x3472B2FEF357cC2C239B32b1791eE1a5C7484096); 
        operationsWallet = address(0x3472B2FEF357cC2C239B32b1791eE1a5C7484096);
