...
//			  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//
//		Vocare ex Machina is the first decentralized influencer bot that calls through community votes.
//             https://vocare.io  |  https://t.me/vocareio  |   https://twitter.com/vocareio
//                 
// 
//
...
contract VOCARE is ERC20, Ownable {
    ...
    constructor(address owner_, address growth_) ERC20("Vocare ex Machina", "VOCARE") {
	   require(owner_ != address(0), "Zero address");
	   require(growth_ != address(0), "Zero address");
	   
	   router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
       pair = IDEXFactory(router.factory()).createPair(address(this), router.WETH());
	   
	   growthWallet = address(growth_);
       ...
       _mint(address(owner_), 10000000 * (10**18));
