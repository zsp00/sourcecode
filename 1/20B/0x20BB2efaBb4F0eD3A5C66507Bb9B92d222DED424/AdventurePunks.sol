...
// File: contracts/AdventurePunks.sol
...
contract AdventurePunks is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 5967;
  ...
  ) ERC721A("AdventurePunks", "ADVPUNK") {
