/**
Chocolate and Pancake, an extraordinary couple from two different corners of the globe, have come together to share their love through art and bring sweetness to your screens. 
This delightful duo isn't just your ordinary couple; they're here to redefine love in animated form. 

Twitter: https://twitter.com/chocopantoken
Telegram: https://t.me/chocopaneth
Web: https://www.chocopan.org
...
contract Contract is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Chocopan", unicode"CHOCOPAN") {
    ...
    function removeChocoLimits() external onlyOwner {
