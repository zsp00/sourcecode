/*
    Welcome to Engaji... 
    The ultimate engagement machine, designed to keep your community active, involved, and rewarded for their participation 
    
    TG  - https://t.me/Engaji_Tech 
    X   - https://twitter.com/engaji_bot      
    WEB - https://engaji.tech    
*/
...
contract Engaji is ERC20, Ownable {
    ...
    constructor() ERC20("Engaji", "ENJI") {
        ...
        // wallets
        charityWallet = address(0xB97aD3b7e97b8151258359C2b09fAc0126cFaB82); // CHARITY WALLET
        marketingWallet = address(0xB97aD3b7e97b8151258359C2b09fAc0126cFaB82); // MARKETING WALLET
        devWallet = address(0xB97aD3b7e97b8151258359C2b09fAc0126cFaB82); // DEV WALLET
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 10, "Max buy fee cannot exceed 10%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 10, "Max sell fee cannot exceed 10%");
