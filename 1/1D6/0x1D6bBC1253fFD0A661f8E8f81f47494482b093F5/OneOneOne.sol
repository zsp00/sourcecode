/**
    ...
    Wormouse! Why are you looking at this? You should be preparing to take over the world.

    https://t.me/mouseworm
...
contract OneOneOne is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nopegoingto500mil", "MissedMouseworm?") {
