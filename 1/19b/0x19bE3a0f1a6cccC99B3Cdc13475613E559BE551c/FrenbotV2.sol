...
Telegram Bot: https://t.me/mef_frenbot
...
contract FrenbotV2 is ERC20, Ownable {
    ...
    constructor() ERC20("FRENBOT", "MEF") {
        ...
        revShareWallet = address(0x83D31Ab1D424C220e67d97ad2dFbA2369d3dA32c); // set as revShare wallet
    ...
    function withdrawStuckMef() external onlyOwner {
