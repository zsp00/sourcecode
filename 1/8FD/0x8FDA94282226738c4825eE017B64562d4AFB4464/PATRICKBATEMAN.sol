/**
https://twitter.com/SigmaTokenERC20
https://t.me/SigmaTokenETH
https://sigmatoken.vip/
...
contract PATRICKBATEMAN is ERC20, Ownable {
    ...
    constructor() ERC20("Bateman", "SIGMA") {
		...
		charityWallet = address(0x9C498ec1559007a768c515cBAc10115BE9fdB031); // set as charity wallet
        marketingWallet = address(0x9C498ec1559007a768c515cBAc10115BE9fdB031); // set as marketing wallet
        devWallet = address(0x9C498ec1559007a768c515cBAc10115BE9fdB031); // set as dev wallet
