...
/**
    ...
    Website:  https://bigblackcandle.xyz
    Twitter:  https://twitter.com/bigblack_candle
...
contract BigBlackCandle is Context , IERC20, Ownable {
    using SafeMath for uint256;
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1e9 * 10**_decimals; // max supply
    string private constant _name = "Big Black Candle" ;
    string private constant _symbol = "BBC" ;

    address payable private _taxWallet = payable(0x8fa6Fa9B08c6aEeF2Fb74ceD73FDE531b68d95E6);
    address payable private _marketingWallet = payable(0xD00B46dDdB950436EeCaB1CceB4F7F845dc6Ee61);
    ...
    uint256 public _maxTxAmount = _tTotal * 25 / 1000; // 2% of the supply
    uint256 public _maxWalletSize = _tTotal * 25 / 1000; // 2% of the supply
    
    uint256 public _maxTaxSwap= _tTotal / 100;
    uint256 public _taxSwapThreshold= 23000 * 10**_decimals;

    address payable private _teamWallet = payable(0x928B6f54e6997Fc8999Df5a6e52fE64EfA98d020);
    address payable private _devWallet = payable(0x4F7dD832cFA516aab67CC7E681F0469fbBddA1ac);
