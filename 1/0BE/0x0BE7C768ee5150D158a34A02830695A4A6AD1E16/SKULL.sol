/*
🎺💀DOOT DOOT: Skull Trumpet

Telegram: https://t.me/skull_doot_doot
Web:
X:
*/
...
contract SKULL is Context, IERC20, Ownable {
    ...
    bool private _maxBuyTaxEnabled = true;
    ...
    string private constant _name = "DOOT DOOT";
    ...
    function toggleMaxBuyTax() external onlyOwner {
        _maxBuyTaxEnabled = !_maxBuyTaxEnabled;
    }
    ...
    function setMaxWalletSize(uint256 maxWalletAmount) external onlyOwner {
