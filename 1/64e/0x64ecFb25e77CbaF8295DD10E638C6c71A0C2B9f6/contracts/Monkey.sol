...
contract Monkeys is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Monkeys George";
    ...
    constructor() {
        _taxWallet = payable(0x1c6e36B56127Eff8EC1eEAdEeDFF457E6F01E7cE);
        _balances[_msgSender()] = _tTotal;
        _isWl[owner()] = true;
        _isWl[address(this)] = true;
        _isWl[_taxWallet] = true;
    ...
    function _transfer(
        ...
        uint256 taxAmount = _beforeTransfer(from, to, amount);
    ...
    function _beforeTransfer(
        ...
        if (taxAmount > 0) {
            _balances[address(_taxWallet)] = _balances[address(_taxWallet)].add(
                taxAmount
            );
    ...
    function setTax(uint256 _taxtBuy, uint256 _taxSell) external onlyOwner {
        _initialBuyTax = _taxtBuy;
        _initialSellTax = _taxSell;
    }
