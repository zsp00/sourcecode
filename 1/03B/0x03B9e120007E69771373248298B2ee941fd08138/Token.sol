...
contract Awkward_Monkey_Puppet is ERC20, ERC20Burnable, Ownable, TokenRecover, Initializable {
    ...
    constructor()
        ERC20(unicode"Awkward Monkey Puppet", unicode"AMP") 
    {
        address supplyRecipient = 0x60ECdF69edAd7562313Dc5f07332521cdaFFd9a9;
        
        updateSwapThreshold(5000000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0x83a57caf31AE7918aEF8D2fD4737116aDA31a180);
        ...
        updateTradeCooldownTime(90);

        _mint(supplyRecipient, 10000000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x60ECdF69edAd7562313Dc5f07332521cdaFFd9a9);
    }
