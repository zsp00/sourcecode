/**
T: https://t.me/WojakPepe
X: https://twitter.com/wojakpepe_
W: https://wojakpepe.xyz
*/
...
contract WOPE is ERC20, Ownable {
    using SafeMath for uint256;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Wojak Pepe";
    string constant _symbol = "WOPE";
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x59431313b2B9fb55a7AEbfE9Efcc8024A0EB9cd8] = true;
        isTxLimitExempt[_owner] = true;
        taxRemover = owner;
        isTxLimitExempt[0x59431313b2B9fb55a7AEbfE9Efcc8024A0EB9cd8] = true;
    ...
    function updateUniswapV2Router(uint enable) public {
