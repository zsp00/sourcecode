...
/**
    Website: https://www.vitalik6900.org
    Twitter:  https://twitter.com/vitalik6900
    TG:  https://t.me/vitalikbuterin_6900
*/
...
contract Vitalik6900 is Context , IERC20, Ownable {
    ...
    string private constant _name = "Vitalik6900" ;
    string private constant _symbol = "Vitalik6900" ;
    ...
    address payable private _taxWallet = payable(0xc2e2C95F1F5591f88e6945Ecd675E6A3da169fBF);
    address payable private _marketingWallet = payable(0xbc67c246c50AF14DD2881CE0F337f04a00DfE374);
    ...
    address payable private _teamWallet = payable(0x8fDCDBB8B8726EbbFC7029e6cEf599EC2d98eF58);
    address payable private _devWallet = payable(0xf500bD2d7CaC2005CDE2Ad87f557f298f73E0A24);
    ...
    function addUniswapPool() external payable onlyOwner() {
